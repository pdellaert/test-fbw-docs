...
- [x] Installation Guide - cleanup, split section if required, etc.
  - [ ] Overview **REQURIES FINAL LINKS** 
  - [x] Versions
    - Add simple versioning table
  - [x] Installation (TODO: Part 2)
    - Add A380X specific installation links / steps 
  - [x] Settings (minor changes possibly required)
- [x] A32NX
  - [x] Overview
  - [x] Feature Guides - split into a32nx/a380x specific features and common features
  - [x] API
- [ ] A380X
...
- [x] SimBrief guide needs update + New Page
- [ ] Discontinuities
...
All advance guides currently need to be re-written / split up / copied to the A380. 
